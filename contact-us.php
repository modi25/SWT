                        ...
                        <div class="m-t-30">
                            <form  action="sendmail.php"  method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="msg" rows="5" class="form-control required" placeholder="Enter your Message"></textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                 <address>
                                  ...
                                  Kota - 324005</br>
                                  <abbr title="Phone">Phone No:</abbr> +91 7737634978
                                  </address>
                            ...
                            <div class="col-md-6">
                               <address>
                                  ...
                                  NJ 08837, USA<br>
                                  <abbr title="Phone">Phone No:</abbr> +1 (412) 482-2783
                                  </address>
                            </div>
                        </div>
